  ...
  create or replace  view NHL_DB.ANALYTICS.game_player_stats
...
from NHL_DB.ANALYTICS.stg_game_roster d

left join NHL_DB.ANALYTICS.stg_game_player_stats g 
on g.player_id = d.player_id and g.game_id = d.game_id 

left join NHL_DB.ANALYTICS.stg_game_metadata m
on m.game_id = d.game_id 

left join NHL_DB.ANALYTICS.stg_game_teams t 
on t.team_id = d.team_id  and t.game_id = d.game_id

left join NHL_DB.ANALYTICS.stg_game_divisions div 
on t.team_id = div.team_id  and t.game_id = div.game_id

left join NHL_DB.ANALYTICS.stg_game_conferences conf 
