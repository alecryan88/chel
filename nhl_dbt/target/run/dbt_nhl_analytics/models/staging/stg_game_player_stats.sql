  ...
  create or replace  view NHL_DB.ANALYTICS.stg_game_player_stats
  ...
  from NHL_DB.ANALYTICS.stg_game_events a

  left join NHL_DB.ANALYTICS.stg_game_events_players b 
