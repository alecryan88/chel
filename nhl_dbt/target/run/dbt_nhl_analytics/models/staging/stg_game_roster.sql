  ...
  create or replace  view NHL_DB.ANALYTICS.stg_game_roster
...
from NHL_DB.RAW.RAW_NHL_GAME_DATA, table(flatten(JSON_EXTRACT:liveData:boxscore:teams:away:players)) players
...
from NHL_DB.RAW.RAW_NHL_GAME_DATA, table(flatten(JSON_EXTRACT:liveData:boxscore:teams:home:players)) players
  );
